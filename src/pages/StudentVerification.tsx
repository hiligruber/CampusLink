                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-full text-sm border transition-all ${
                            on
                              ? "bg-gradient-to-r from-primary to-accent text-white border-transparent shadow-sm scale-105"
        ...
        <div className="flex items-center gap-2">
          ...
          {step < TOTAL_STEPS ? (
            <Button
              onClick={() => setStep((s) => s + 1)}
              disabled={!canNext()}
              className="rounded-full flex-1 bg-gradient-to-r from-primary to-accent hover:opacity-95"
            >
