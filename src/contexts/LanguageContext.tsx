...
const dict = {
  ...
  open_in_waze: { EN: "Open in Waze", HE: "פתח בוויז" },
  navigate_stops: { EN: "Navigate to stops", HE: "ניווט לעצירות" },
  rate_driver: { EN: "Rate driver", HE: "דרגו את הנהג" },
  rating_submitted: { EN: "Rated", HE: "דורגה" },
  ...
  btn_on_the_way: { EN: "I'm on my way", HE: "אני בדרך" },
  ...
  toast_passengers_notified: { EN: "Passengers have been notified you're on the way", HE: "הנוסעים קיבלו עדכון שאתה בדרך" },
